...
#SBATCH --output="/home/users/steveb/io500-lotus/io500/runs/quobyte-2-2-300-0-POSIX/slurm-%j.out"
...
echo dimensions: '{"nodes": 2, "ntasks_per_node": 2, "filesystem": {"name": "quobyte", "mountpoint": "/gws/nopw/j04/perf_testing3/stackhpc"}, "stonewall": 300, "iters": 0, "time": "4:0:0", "ior_api": "POSIX"}'
