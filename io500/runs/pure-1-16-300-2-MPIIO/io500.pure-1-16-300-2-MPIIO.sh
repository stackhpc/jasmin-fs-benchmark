...
#SBATCH --output="/home/users/steveb/io500-lotus/io500/runs/pure-1-16-300-2-MPIIO/slurm-%j.out"
...
echo dimensions: '{"nodes": 1, "ntasks_per_node": 16, "filesystem": {"name": "pure", "mountpoint": "/work/stackhpc-pure/"}, "stonewall": 300, "iters": 2, "time": "4:0:0", "ior_api": "MPIIO"}'
