...
mpirun singularity exec --bind /work/stackhpc-pure/:/work/stackhpc-pure/ docker://ghcr.io/stackhpc/io500-singularity:${IO500_CONTAINER_TAG} /io500 /home/users/steveb/io500-lotus/io500/runs/pure/config.pure-1-2.ini --timestamp $timestamp
