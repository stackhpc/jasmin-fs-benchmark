...
mpirun singularity exec --bind /work/scratch-nopw/:/work/scratch-nopw/ docker://ghcr.io/stackhpc/io500-singularity:${IO500_CONTAINER_TAG} /io500 ./runs/quobyte/config.quobyte-1-2.ini --timestamp $timestamp
